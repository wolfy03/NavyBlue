...
var candidate_sustained_dps := 0.0
var candidate_ready_salvo_damage := 0.0
var candidate_torpedo_salvo_damage := 0.0
var candidate_cannon_sustained_dps := 0.0
var candidate_strategic_value := 0.0
var owner_target_within_weapon_range := false
var owner_can_attack_now := false
