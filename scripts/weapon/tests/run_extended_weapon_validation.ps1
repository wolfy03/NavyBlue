...
$tests = @(
	...
	"res://scripts/aircraft/tests/DiveBombNoLegacyPathTest.gd",
	"res://scripts/aircraft/tests/DiveBombIndividualAircraftSolutionTest.gd",
	"res://scripts/aircraft/tests/DiveBombSharedCoordinatorContractTest.gd",
	"res://scripts/aircraft/tests/DiveBombAttackResolverTest.gd",
	"res://scripts/aircraft/tests/DiveBombImpactAccuracyTest.gd",
	"res://scripts/aircraft/tests/DiveBombAccuracyProfileDeterminismTest.gd",
	"res://scripts/aircraft/tests/DiveBombAccuracyProfilePerfectAccuracyTest.gd",
	"res://scripts/aircraft/tests/DiveBombAccuracyProfileSingleApplicationTest.gd",
	"res://scripts/aircraft/tests/DiveBombAccuracyProfileTargetChangeTest.gd",
	"res://scripts/aircraft/tests/DiveBombAccuracyTrackingPositionTest.gd",
	"res://scripts/aircraft/tests/DiveBombTargetResolverExplicitShipTest.gd",
	"res://scripts/aircraft/tests/DiveBombTargetResolverNearestShipTest.gd",
	"res://scripts/aircraft/tests/DiveBombTargetResolverHostileOnlyTest.gd",
	"res://scripts/aircraft/tests/DiveBombTargetResolverPositionFallbackTest.gd",
	"res://scripts/aircraft/tests/DiveBombTargetResolverNoFallbackTest.gd",
	"res://scripts/aircraft/tests/DiveBombTargetResolverDeterministicTieBreakTest.gd",
	"res://scripts/aircraft/tests/DiveBombAIDesignationAutoAcquireTest.gd",
	"res://scripts/aircraft/tests/DiveBombAIExplicitTargetPriorityTest.gd",
	"res://scripts/aircraft/tests/DiveBombAITargetDestroyedDuringApproachTest.gd",
	"res://scripts/aircraft/tests/DiveBombPlayerExplicitTargetPriorityTest.gd",
	"res://scripts/aircraft/tests/DiveBombPlayerDesignationAutoAcquireTest.gd",
	"res://scripts/aircraft/tests/DiveBombPlayerPositionFallbackTest.gd",
	"res://scripts/combat/tests/CombatIdentityDeterminismTest.gd",
